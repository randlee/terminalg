...
MUST READ: `.claude/skills/rust-development/guidelines.txt` and `.claude/skills/rust-development/gpui-zed-guidelines.md` before analysis or recommendations. All architecture decisions must align with these guidelines.
