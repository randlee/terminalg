...
MUST READ: `.claude/skills/rust-development/guidelines.txt` and `.claude/skills/rust-development/gpui-zed-guidelines.md` before reviewing. All findings must align with these guidelines.
